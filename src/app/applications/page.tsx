        ...
        <div style={{ background: "var(--bg-primary)" }}>
            ...
            <section className="section-pad grid-bg" style={{ borderBottom: "1px solid var(--border-subtle)" }}>
                <div className="section-container">
                    <div className="tag-pill" style={{ marginBottom: "1.5rem" }}>Applications</div>
                    ...
                    <p style={{ color: "var(--text-secondary)", maxWidth: "580px", lineHeight: 1.85, fontSize: "1.0625rem" }}>
                        Mattera's intelligence infrastructure serves four distinct segments — delivering
                        precision health monitoring across companion animals, veterinary clinics, livestock
                        operations, and performance animals.
                    </p>
